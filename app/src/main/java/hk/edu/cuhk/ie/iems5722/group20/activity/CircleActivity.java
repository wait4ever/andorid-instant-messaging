...
import hk.edu.cuhk.ie.iems5722.group20.adapter.CircleAdapter;
import hk.edu.cuhk.ie.iems5722.group20.asynctask.HttpGetTask;
import hk.edu.cuhk.ie.iems5722.group20.asynctask.NewPostRequest;
import hk.edu.cuhk.ie.iems5722.group20.entity.Circle;
...
public class CircleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 获取朋友圈信息
        String url = "http://34.238.52.71/api/project/posts?user_id="+userInfo.id;
    ...
    private String postRequest(String postContent){
        String URLString = "http://34.238.52.71/api/project/posts";
        String[] parameters = new String[]{URLString,String.valueOf(userInfo.id),postContent};
        String result="";
