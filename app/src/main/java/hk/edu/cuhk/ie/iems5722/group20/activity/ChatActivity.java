package hk.edu.cuhk.ie.iems5722.group20.activity;
...
import hk.edu.cuhk.ie.iems5722.group20.adapter.MessageAdapter;
import hk.edu.cuhk.ie.iems5722.group20.asynctask.HttpGetTask;
import hk.edu.cuhk.ie.iems5722.group20.asynctask.PostMessageTask;
...
//                String name = userInfo.nickName;
                String send_user = String.valueOf(userInfo.id);
                String receive_user = target_user_id;

                String URLString = "http://34.238.52.71/api/project/messages";
                ...
                if (!("".equals(message))){
                    ...
                    Date now = new Date();
                    Message newMessage = new Message(send_user,dateFormat.format(now),message,String.valueOf(userInfo.id));
    ...
    private void updateList(String chatRoomId, int pageNum){
        ...
        // 获取数据
        String url = "http://34.238.52.71/api/project/messages?curr_user="+userInfo.id+"&target_user="+target_user_id;
