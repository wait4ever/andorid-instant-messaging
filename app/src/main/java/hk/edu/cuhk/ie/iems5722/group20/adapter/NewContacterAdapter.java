    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //
                String url = "http://34.238.52.71/api/project/accpet_or_refuse?operation="+1+
                        "&request_name='"+nickName.getText()+"'&receive_id="+userInfo.id;
        ...
        refuse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "http://34.238.52.71/api/project/accpet_or_refuse?operation="+0+
                        "&request_name='"+nickName.getText()+"'&receive_id="+userInfo.id;
                responseToRequest(url,nickName);
            }
        });
